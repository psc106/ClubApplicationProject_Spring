...
<img width="40px" height="40px" src="<%=url+"/"+attach_path+getProfileImage%>" />
</span>
<span class="user_profile">
...
<div class="board_picture">
  ...
  <div><img class="board_picture_content" src="<%=url+"/"+attach_path+getPostImage.get(i) %>" /></div>
  <%} %>
</div>
<%}%>
...
<img width="40px" height="40px" src="<%=url+"/"+attach_path+getMyProfileImage%>" />
</span>
<span class="user_profile">
<div id="board_user_name"><%=getMynickname %></div>
<time id="board_time" datetime="2018-08-21">5시간 전</time>
</span>

<form action="insert_comment.do?id=<%=club_info.getId()%>&post_id=<%=postProfileDetail.getPost().getId()%>" id="insert_comment_form" method="post">
<textarea name="comment_content" id="comment_content" cols="80" rows="6"></textarea>
...
<span class="user_comment_profile">
<img width="40px" height="40px" src="<%=url+"/"+attach_path+getCommentList.get(i).getImg_db_name()%>" />
</span>
<span class="user_profile">
