...
//	}
	...
	@RequestMapping(value = "mobile/deletePost.do", produces = "application/json; charset=utf8")
	@ResponseBody
	public String deletePost_toMobile(HttpServletRequest request) {
		iDaoMobile dao = sqlSession.getMapper(iDaoMobile.class);
		String postIdStr = request.getParameter("postId");
		String memberIdStr = request.getParameter("memberId");
		Long postId;
		...
		if(appService.deletePost(postId, memberId)) {		
			return gson.toJson(true);
		} else {	
	...
	@RequestMapping(value = "mobile/updatePost.do", produces = "application/json; charset=utf8")
	@ResponseBody
	public String updatePost_toMobile(HttpServletRequest request) {
		iDaoMobile dao = sqlSession.getMapper(iDaoMobile.class);
		...
		MultipartHttpServletRequest multiRequest = (MultipartHttpServletRequest) request;
		String content = request.getParameter("content");
		String deletList = request.getParameter("deletList");
		String postIdStr = request.getParameter("postId");
		String memberIdStr = request.getParameter("memberId");
		
		Long postId;
		Long memberId;
		String[] deleteListArray = deletList.trim().split(",");
		...
		appService.updatePost(postId, memberId, content, images, deleteListArray);
		return gson.toJson("");
	}
	
	@RequestMapping(value = "mobile/updateProfile.do", produces = "application/json; charset=utf8")
	@ResponseBody
	public String updateProfile_toMobile(HttpServletRequest request) {
		iDaoMobile dao = sqlSession.getMapper(iDaoMobile.class);
		String rootPath = request.getSession().getServletContext().getRealPath("/");
		String attachPath = "resources/upload/";
		String uploadPath = rootPath + attachPath;
		...
		appService.updateProfile(image, clubId, memberId);
		return gson.toJson(true);
	}
	...
	public String refreshPostComment_toMobile(HttpServletRequest request) {
		...
		ArrayList<CommentView> items = dao.refreshPostComment(postId, page, pageCount);
	...
	public String selectPostComment_toMobile(HttpServletRequest request) {
		...
		ArrayList<CommentView> items = dao.selectPostComment(postId, page, pageCount);
	...
	@RequestMapping(value = "mobile/updateAdmin.do", produces = "application/json; charset=utf8")
	@ResponseBody
	public String updateAdmin_toMobile(HttpServletRequest request) {
		iDaoMobile dao = sqlSession.getMapper(iDaoMobile.class);
		String clubIdStr = request.getParameter("clubId");
		...
		dao.updateAdmin(targetId, memberId, clubId);
	...
	@ResponseBody
	public String deleteMember_toMobile(HttpServletRequest request) {
		iDaoMobile dao = sqlSession.getMapper(iDaoMobile.class);
		String clubIdStr = request.getParameter("clubId");
		String targetIdStr = request.getParameter("targetId");
		String memberIdStr = request.getParameter("memberId");
		...
		dao.deleteMember(targetId, memberId, clubId);

		return gson.toJson("");
	}

	@RequestMapping(value = "mobile/updateMember.do", produces = "application/json; charset=utf8")
	@ResponseBody
	public String updateMember_toMobile(HttpServletRequest request) {
		iDaoMobile dao = sqlSession.getMapper(iDaoMobile.class);
		String clubIdStr = request.getParameter("clubId");
		String targetIdStr = request.getParameter("targetId");
		String memberIdStr = request.getParameter("memberId");
		...
		dao.updateMember(targetId, memberId, clubId);
